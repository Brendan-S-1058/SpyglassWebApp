...
def Main ():
    ...
    finArray+=(str((100*holdLoc/holdTotal)//1)) + ','
    finArray+=(str((100*holdAlgae/holdTotal))//1) + ','
    finArray+=(str((100*holdCoral/holdTotal))//1) + ','
    finArray+=(str((100*holdAuto/holdTotal))//1) + ','
    finArray+=(str((100*holdTele/holdTotal)//1)) + ','
