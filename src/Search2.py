...
def Main ():
    ...
    finArray+=(str(100*holdLoc/holdTotal)) + ','
    finArray+=(str(100*holdAlgae/holdTotal)) + ','
    finArray+=(str(100*holdCoral/holdTotal)) + ','
    finArray+=(str(100*holdAuto/holdTotal)) + ','
    finArray+=(str(100*holdTele/holdTotal)) + ','
